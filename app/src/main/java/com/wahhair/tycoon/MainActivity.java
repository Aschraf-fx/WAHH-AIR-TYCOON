...
public class MainActivity extends Activity {
 private WebView web; private String pending;
 ...
 @Override protected void onPause(){web.evaluateJavascript("if(window.onGameBackground)onGameBackground()",null);web.onPause();super.onPause();}
